            ...
            success:function (data) {
                $.each(data,function (index,first) {
                    ...
                    $.each(first.children, function (index1,second) {
                        alert(second.href);
                        c +="<p style='text-align: center'><a  href='javascript:void(0);' class =\"easyui-linkbutton\" data-options=\"iconCls:'"+second.iconCls+"'\"  onclick=\"addTabs('"+second.title+"','"+second.href+"','"+second.iconCls+"')\">"+ second.title+"</a></p>";
                  });
                   $("#aa").accordion('add',{
                       title:first.title,
                       content:c,
